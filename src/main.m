...
parameter = {WaveletVarianceParameters(),StatisticParameters("mean")};
try
        [accuracy, accuracy_chance, kappa, kappa_chance] = fixed_train_classifier(data_250, data_50, 100, 20, parameter);
